package com.mstarc.lib.watchface.base;
...
import com.mstarc.lib.watchface.R;
import com.mstarc.lib.watchface.utils.IntenetUtil;
import com.mstarc.lib.watchface.utils.Logger;
import com.mstarc.lib.watchface.utils.WeakHandler;
import com.mstarc.lib.watchface.weather.Weather;
import com.mstarc.lib.watchface.weather.manager.WeatherManager;
    ...
    protected abstract class CommonWallpaperEngine extends Engine
        ...
        public void onCreate(SurfaceHolder surfaceHolder) {
            ...
            getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(SETTINGS_SPORT_STEPS_TARGET),
                    true,
                    mSettingsContentObserver);
            getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(SETTINGS_SPORT_STEPS_CURRENT),
                    true,
                    mSettingsContentObserver);
            getContentResolver().registerContentObserver
                    (Settings.System.getUriFor(SETTINGS_SPORT_STEPS_SPORTSTEPS),
                     true,
                     mSettingsContentObserver);
            getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(SETTINGS_SPORT_STEPS_ISSPORT),
                    true,
                    mSettingsContentObserver);
         ...
         *          每天走的步数:mStep
         *      1 表示在运动中
         *          运动的步数:  Settings.System.putInt(getContentResolver(), "sportSteps",
         *                                            (int) data.getStep());
